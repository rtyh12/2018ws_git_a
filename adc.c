...
void ADCInit(uint8_t kanal) {
	...
	// Sollen mehrere Pins verwendet werden, diese Funktion mehrfach
	// aufrufen oder manuell die entsprechenden Pins als Eingang setzen
	DDRC &= ~(1 << kanal);

	// Frequenzvorteiler setzen auf 128 und ADC aktivieren
	// Frequenz des ADC = Frequenz des Controllers (16 Mhz) geteilt durch
	// Frequenzteiler
	...
	// liest also einen Wert und verwirft diesen, um den ADC "warmlaufen
	// zu lassen" 
